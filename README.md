...
Amplify アプリを削除すると、Hosting・Cognito・Session Binding API に加え、CDK 管理の Gateway・ターゲット・Credential Provider・Runtime もまとめて消えます。sandbox は `pnpm ampx sandbox delete` です。
